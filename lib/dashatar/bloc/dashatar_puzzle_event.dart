...
class DashatarCountdownReverse extends DashatarPuzzleEvent {
  const DashatarCountdownReverse();
}

class DashatarCountdownReverseTicked extends DashatarPuzzleEvent {
  const DashatarCountdownReverseTicked();
}

class DashatarCountdownReverseStopped extends DashatarPuzzleEvent {
