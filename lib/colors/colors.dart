...
abstract class PuzzleColors {
  ...
  /// Green primary
  static const Color customPrimary = Color.fromARGB(255, 80, 0, 60);

  /// Green 90
  static const Color custom90 = Color.fromARGB(255, 113, 247, 191);

  /// Green 50
  static const Color custom50 = Color.fromARGB(255, 1, 107, 156);

  /// Blue primary
  static const Color bluePrimary = Color.fromARGB(255, 0, 23, 100);
